...
def process(file: str):
    ...
    labeled_tadpole_kp_deltas = {
        "del1": absolute_distance(
            labeled_tadpole_kp_coords["pos_rostrum"],
            labeled_tadpole_kp_coords["pos_tailbase"],
        ),
        "del2": absolute_distance(
            labeled_tadpole_kp_coords["pos_tailbase"],
            labeled_tadpole_kp_coords["pos_tailbase_third"],
        ),
        "del3": absolute_distance(
            labeled_tadpole_kp_coords["pos_tailbase_third"],
            labeled_tadpole_kp_coords["pos_tailtip_third"],
        ),
        "del4": absolute_distance(
            labeled_tadpole_kp_coords["pos_tailtip_third"],
            labeled_tadpole_kp_coords["pos_tailtip"],
        ),
    }
    ...
    for a, b in tadpole_connections:
        ...
        cv2.line(
            img, (int(x1), int(y1)), (int(x2), int(y2)), (0, 255, 0), 12
