...
scale_spliner = YOLO("app/models/scale_model_output/run_20260315_085612/weights/best.pt")
tadpole_spliner = YOLO("app/models/spline_model_output/initial/pose/train/weights/best.pt")
...
def main():
    ...
    for file_path in Path("app/data/production/input").iterdir():
        try:
